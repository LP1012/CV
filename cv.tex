...
\begin{resume}
  ...
  Advanced nuclear reactors, neutral particle transport, reactor multiphysics, scientific computing, open source software.
  %
  %__________________________________________________________________________________________________________________
  ...
  % \cvbibsection{Journal Publications}{Journals}

  %__________________________________________________________________________________________________________________
  % Conference Publications
  \cvbibsection{Conference Papers}{ConfPapers}

  %__________________________________________________________________________________________________________________
  % Technical Reports
  \cvbibsection{Technical Reports}{TechReports}
