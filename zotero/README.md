...
2. Update the supplied `json` file to match the user's name, along with any preferences for subcollection names.
3. Import the `json` settings file in the Better BibTeX settings.
